      ...
      <div className={styles["AdminPanel-wrapper-cover"]}>
        <div className={styles["AdminPanel-wrapper-course-cover"]}>
          ...
          <div className={styles["AdminPanel-wrapper-course-cover-div"]}>
            <img src={add} />
            <div className={styles["AdminPanel-wrapper-course-cover-div-head"]}>
              Choose a file or drag & drop it here
            </div>
            <div className={styles["AdminPanel-wrapper-course-cover-div-text"]}>
        ...
        <div className={styles["AdminPanel-wrapper-description"]}></div>
      </div>
    </div>
  );
};
